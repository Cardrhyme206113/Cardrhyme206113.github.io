# Flow-enabled mapmaker copy v1.0.0

This folder is isolated from the restored root `simbers.html`.
...
ArcViewer is deliberately **not copied**. The copied mapmaker continues to use its remotely hosted ArcViewer bridge.
